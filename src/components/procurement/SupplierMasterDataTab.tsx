...
export function SupplierMasterDataTab({ supplier }: SupplierMasterDataTabProps) {
    ...
    return (
      <div className="space-y-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Konditionen */}
          <Card>
            <CardHeader><CardTitle className="text-base">Konditionen</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          {/* Bankdaten */}
          <Card>
            <CardHeader><CardTitle className="text-base">Bankdaten</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <Label htmlFor="master-bank_name">Bank</Label>
                ...
                <div>
                  ...
                  <Input id="master-payment_reference" name="payment_reference" defaultValue={supplier.payment_reference || ''} />
                </div>
                <div>
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Allgemein */}
      <Card>
        <CardHeader><CardTitle className="text-base">Allgemein</CardTitle></CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><Label>Lieferantennummer</Label><p className="text-sm mt-1">{supplier.supplier_number || '-'}</p></div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div><Label>Adresse</Label><p className="text-sm mt-1 whitespace-pre-line" data-testid="detail-address">{supplier.address || '-'}</p></div>
            <div><Label>Rechnungsadresse</Label><p className="text-sm mt-1 whitespace-pre-line">{supplier.billing_address || '-'}</p></div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><Label>Bank</Label><p className="text-sm mt-1" data-testid="detail-bank-name">{supplier.bank_name || '-'}</p></div>
            <div><Label>Kontoinhaber</Label><p className="text-sm mt-1" data-testid="detail-account-holder">{supplier.account_holder || '-'}</p></div>
            <div><Label>Feste Referenznummer</Label><p className="text-sm mt-1">{supplier.payment_reference || '-'}</p></div>
            <div><Label>Verwendungszweck</Label><p className="text-sm mt-1">{supplier.payment_purpose || '-'}</p></div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">Anmerkungen</CardTitle></CardHeader>
        <CardContent>
          <p className="text-sm whitespace-pre-line" data-testid="detail-notes">{supplier.notes || '-'}</p>
        </CardContent>
      </Card>
    </div>
  )
